...
--
-- Máy chủ: localhost
-- Thời gian đã tạo: Th5 02, 2019 lúc 02:18 PM
...
(19, '13', 1, NULL, NULL, '1802816e-0077-4f75-8144-b2f81c7daaef', NULL, 1, '2019-04-08 04:46:28', '2019-05-02 11:37:51'),
...
(88, '50', 1, NULL, NULL, '739b4bf2-b516-4d05-9e52-d0c79933c085', NULL, 1, '2019-04-09 10:28:29', '2019-05-02 12:17:02'),
...
(68, 0, NULL, '356d4085-8087-4464-98ad-025438f39676', 1, 133, 134, '2019-05-02 09:50:59', '2019-05-02 09:50:59'),
(69, 0, NULL, 'a4117da0-6312-467e-bf1f-52e6e110f2a9', 1, 135, 136, '2019-05-02 11:10:16', '2019-05-02 11:10:16'),
(70, 0, NULL, 'ccb0c938-5f90-4a76-94a1-11a5112e8695', 1, 137, 138, '2019-05-02 11:18:00', '2019-05-02 11:18:00');
...
(73, 'vi', 'Banners', 19, 'title', 'DEVELOPMENT HISTORY – LỊCH SỬ PHÁT TRIỂN'),
(74, 'vi', 'Banners', 19, 'slug', 'development-history-lich-su-phat-trien'),
...
(351, 'vi', 'Banners', 88, 'description', '<div>Ra mắt vào 18/07/2016.</div><div>Launched on 18 July 2016.</div><div>Là trò chơi chọn 06 số bất kỳ trong 45 số từ 01 đến 45 để tạo thành một bộ số tham gia dự thưởng chỉ từ 10.000 đồng.</div><div>The player picks any 06 numbers from 01 to 45 to create a combination with only 10,000 VND.</div><div>Người chơi có thể tự mình chọn số hoặc để máy tính chọn số ngẫu nhiên (TC).</div><div>The player can self-select the numbers or let the system selects the numbers randomly.&nbsp;</div><div>Ngày quay số mở thưởng từ 18:00 đến 18:30 các ngày thứ 4, thứ 6 và Chủ Nhật hàng tuần.</div><div>Mega 6/45 live draw at 18:00 to 18:30 every Wednesday, Friday and Sunday weekly.</div><div>Xem kết quả quay số mở thưởng và dò số:</div><div>Draw result and compare draw result:</div><div>- Xem quay số mở thưởng trực tiếp trên truyền hình VTC3, tại fanpage: https://www.facebook.com/vietlott.vn/ hoặc tại trang web Vietlott: vietlott.vn</div><div>Watch live draw on broadcasting channel VTC3, at fanpage: https://www.facebook.com/vietlott.vn/ or at Vietlott’s official website: vietlott.vn</div><div>- Nhắn tin vào đầu số 8179, 8351, 9939, 9141</div><div>Text “MEGA” and send to 8179, 8351, 9939, 9141</div><div>- Có thể mang vé tới Điểm Bán Hàng để kiểm tra trúng thưởng</div><div>The player can bring ticket to the POS to check the draw result to determine the winning prize</div><div><br></div>'),
