<?php
namespace Article\Test\Fixture;
...
class ArticleCategoriesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'order' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => '0', 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        'allowed_fields' => ['type' => 'text', 'length' => null, 'null' => true, 'default' => null, 'collate' => 'utf8_unicode_ci', 'comment' => '', 'precision' => null],
        '_constraints' => [
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'lft' => 1,
                'rght' => 1,
                'created' => '2019-02-24 10:24:15',
                'modified' => '2019-02-24 10:24:15',
