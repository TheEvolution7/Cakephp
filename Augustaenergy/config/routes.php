...
Router::scope('/', function (RouteBuilder $routes) {
    ...
    $routes->connect(
        '/blogs/',
        ['controller' => 'Articles', 'action' => 'article'], ['routeClass' => 'ADmad/I18n.I18nRoute']
    );
    $routes->connect(
        '/blogs/',
        ['controller' => 'Articles', 'action' => 'article']
    );

    $routes->connect(
        '/projects/',
        ['controller' => 'Articles', 'action' => 'projects'], ['routeClass' => 'ADmad/I18n.I18nRoute']
    );
    $routes->connect(
        '/projects/',
        ['controller' => 'Articles', 'action' => 'projects']
    );
    ...
    $routes->connect(
        '/blog/:slug-:id',
        ['controller' => 'Articles', 'action' => 'articleDetails'], ['routeClass' => 'ADmad/I18n.I18nRoute']
    )
    ->setPass(['slug', 'id'])
    ->setPatterns([
        'slug' => '[a-z0-9-_]+',
    ...
    $routes->connect(
        '/blog/:slug-:id',
        ['controller' => 'Articles', 'action' => 'articleDetails']
    )
    ->setPass(['slug', 'id'])
    ->setPatterns([
        'slug' => '[a-z0-9-_]+',
    ...
    $routes->connect(
        '/project/:slug-:id',
        ['controller' => 'Articles', 'action' => 'projectDetails'], ['routeClass' => 'ADmad/I18n.I18nRoute']
    )
    ->setPass(['slug', 'id'])
    ->setPatterns([
        'slug' => '[a-z0-9-_]+',
    ...
    $routes->connect(
        '/project/:slug-:id',
        ['controller' => 'Articles', 'action' => 'projectDetails']
    )
    ->setPass(['slug', 'id'])
    ->setPatterns([
        'slug' => '[a-z0-9-_]+',
