            ...
            ?>
                <div class="tab-content">
                        ...
                        <div class="row">
                            <div class="col-lg-9">
                                ...
                                <?= $this->Form->control('anysize', [
                                    'type' => 'checkbox', 
                                    'label' => ['class' => 'kt-checkbox ta-checkbox','text' => __d('acp', 'Any Size')], 
                                    'div' => false,
                                    'templates' => [
                                        'nestingLabel' => '<label class="col-form-label col-md-3 col-sm-3 col-12">{{text}}</label><div class="col-md-7 col-sm-9 col-12"><div class="kt-checkbox-inline"><label{{attrs}}>{{hidden}}{{input}}' . __d('acp', 'Status') . '<span></span></label></div></div>',
                                    ]
                                ...
                                <!-- <?= $this->Form->control('transport_fee', ['class' => 'form-control', 'label' => ['class' => 'col-form-label col-md-3 col-sm-3 col-12']]); ?> -->
                            </div>
                            <div class="col-lg-3">
                    ...
                    <div class="tab-pane" id="tab_6" role="tabpanel">
                        <div class="row">
                            <div class="col-lg-9">
                                <?= $this->Form->control('paypal_url', ['class' => 'form-control', 'label' => ['class' => 'col-form-label col-md-3 col-sm-3 col-12']]); ?>
                                ...
                                <?= $this->Form->control('paypal_status', ['class' => 'form-control', 'label' => ['class' => 'col-sm-3 col-form-label']]); ?>
                            </div>
                        </div>
                    </div>
                </div>
