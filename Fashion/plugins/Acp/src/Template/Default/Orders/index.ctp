...
$shipping = [
    1 => '<label class="badge badge-info">Ship</label>',
    2 => '<label class="badge badge-success">Pickup</label>',
  ];
 ?>
                                ...
                                <tr data-id="<?= $order->id?>" class="text-center">
                                    ...
                                    <!-- <td>
                                        <?php if ($order->is_active == 1): ?>
                                            <label class="badge badge-success">In London</label>
                                        <?php else: ?>
                                            <label class="badge badge-danger">Out London</label>
                                        <?php endif ?>
                                    </td> -->
                                    <td><?= $order->status ?></td>
