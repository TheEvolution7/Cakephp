...
Router::scope('/', function (RouteBuilder $routes) {
    ...
    $routes->connect('/how-it-work', ['controller' => 'Pages', 'action' => 'work'], ['routeClass' => 'ADmad/I18n.I18nRoute']);
    $routes->connect('/how-it-work', ['controller' => 'Pages', 'action' => 'work']);
    ...
    $routes->connect(
        '/blog/',
        ['controller' => 'Articles', 'action' => 'blog'], ['routeClass' => 'ADmad/I18n.I18nRoute']
    );
    $routes->connect(
        '/blog/',
        ['controller' => 'Articles', 'action' => 'blog']
    );
    ...
    $routes->connect(
        '/pages/:slug',
        ['controller' => 'Pages', 'action' => 'pages'], ['routeClass' => 'ADmad/I18n.I18nRoute']
    )
    ->setPass(['slug'])
    ->setPatterns([
        'slug' => '[a-z0-9-_]+'
