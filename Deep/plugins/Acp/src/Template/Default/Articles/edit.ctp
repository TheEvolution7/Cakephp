    ...
    <div class="kt-portlet kt-portlet--tabs">
        ...
        <div class="kt-portlet__body">
            ...
            ?>
                    ...
                    <div class="tab-pane active" id="tab_1" role="tabpanel">
                        <div class="row">
                            <div class="col-lg-9">
                                ...
                                ?>
                                <?php if ($article->pdf != ''): ?>
                                    <div class="form-group row" id="link-pdf">
                                        <label class="col-form-label col-md-3 col-sm-3 col-12"></label>
                                        <div class="col-sm-9">
                                            <p><i class="fa fa-link"></i>&nbsp;<?= $this->Html->Link($article->pdf, '/uploads/pdf/' . $article->id . '/' . $article->pdf,['target' => '_blank']) ?>&nbsp;&nbsp;<a href="javascript:;" id="remove-pdf"><i class="fa fa-trash-alt"></i></a></p>
                                        </div>
                                        <input type="hidden" name="remove-pdf">
                                    </div>
                                    <script>
                                    $(document).ready(function(){
                                      $("#remove-pdf").click(function(){
                                        $("#link-pdf").hide();
                                        $('input[name="remove-pdf"]').val(true);
                                      });
                                    });
                                    </script>
                                <?php endif ?>
                                ...
                                <?= $this->Form->control('tags', [
                                    ...
                                    'value' => $tags,
                                    'label' => [
                                        'class' => 'col-form-label col-md-3 col-sm-3 col-12'
                                    ]
                                ]); ?>
                                    ...
                                    <?php if ($key < count($images) -1 ): ?>
                                        <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 col-12 d-flex flex-row mb-3">
                                            <figure class="effect-text-in position-relative w-100 align-self-stretch hover-figure">
                                                <?php 
                                                    if (!empty($article->image)) {
                                                        $imagePath = 'uploads' . DS . 'articles' . DS . $article->id . DS .$image;
                                                        ...
                                                        if ($width > 500) {
                                                            $imagePath = 'uploads' . DS . 'articles' . DS . $article->id . DS . 'thumbnail' . DS . $image;
                                                        }
                                                    } else {
                                                        $imagePath = 'img/no_thumb.png';
                                                    }
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-xs-12">
                                <span class="input-group-append">
                                    ...
                                    <button type="button" onclick="location.href='<?= $this->Url->build(['controller' => 'Articles', 'action' => 'reorderImage', $article->id]) ?>';" class="btn btn-success btn-icon-text"><?php echo __d('acp', 'Sort List Image') ?></button>
                                </span>
                            </div>
                        </div>
                    </div>
                ...
                <input type="hidden" name="image_fix" value="<?php echo $article->image ?>">
                <input type="hidden" name="images" value="<?php echo $article->images ?>">
                <input type="hidden" name="images_delete">
                <input type="hidden" name="id_dir" value="<?php echo isset($article->id)?$article->id:0 ?>">
                <div class="form-group row">
                    <label class="col-form-label col-md-3 col-sm-3 col-12"></label>
