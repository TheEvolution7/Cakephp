                ...
                <ul class="nav nav-tabs nav-tabs-line nav-tabs-line-brand nav-tabs-line-2x nav-tabs-line-right nav-tabs-bold" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#tab_2" role="tab">
                            <i class="flaticon-more-1" aria-hidden="true"></i><?= __d('acp','Social Team') ?>
                        </a>
                    </li>
                </ul>
            </div>
            ...
            ?>
                <div class="tab-content">
                    ...
                    <div class="tab-pane" id="tab_2" role="tabpanel">
                        <div class="row">
                            <div class="col-lg-9">
                                <?= $this->Form->control('facebook', ['class' => 'form-control', 'label' => ['class' => 'col-form-label col-md-3 col-sm-3 col-12']]); ?>
                                <?= $this->Form->control('instagram', ['class' => 'form-control', 'label' => ['class' => 'col-form-label col-md-3 col-sm-3 col-12']]); ?>
                                <?= $this->Form->control('twitter', ['class' => 'form-control', 'label' => ['class' => 'col-form-label col-md-3 col-sm-3 col-12']]); ?>
                                <?= $this->Form->control('pinterest', ['class' => 'form-control', 'label' => ['class' => 'col-form-label col-md-3 col-sm-3 col-12']]); ?>
                            </div>    
                        </div>
                    </div>
                </div>
