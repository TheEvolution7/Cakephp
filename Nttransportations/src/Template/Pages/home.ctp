...
<section class="side-image text-heavy clearfix">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-6 col-12 pull-left img-1">
            ...
            <div class="col-lg-6 col-12 content">
                ...
                <div class="row">
                    <div class="col-md-6 no-pad-left feature">
...
<section class="side-image clearfix">
    ...
    <div class="container">
        <div class="row justify-content-between">
            <div class="col-lg-6 content col-12 clearfix order-1 order-lg-0">
            ...
            <!--end of row-->
            <div class="col-lg-5 col-12 pull-right img-2 order-0 order-lg-1">
                <div class="background-image-holder">
...
<section class="pricing-1 bg-secondary-1">
    <div class="container">
        ...
        <?php foreach($package as $pack): ?>
            <div class="col-md-6  col-lg-3 no-pad-right">
...
<section class="no-pad clearfix">
    ...
    <?php foreach($tours as $tour): ?>
        <div class="col-md-6 col-12 no-pad d-flex">
