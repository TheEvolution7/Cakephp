                    ...
                    <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                        <?php foreach($banners[17] as $k => $banner): ?>
                            <div class="panel panel-default card">
                                <div class="panel-heading card-header" role="tab" id="heading-<?= $k ?>">
                                <h4 class="panel-title">
                                    <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapse-<?= $k ?>" aria-expanded="<?= $k == 0 ? 'true' : 'false' ?>" aria-controls="collapse-<?= $k ?>">
