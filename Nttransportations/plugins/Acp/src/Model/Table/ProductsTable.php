...
class ProductsTable extends CoreTable
{
    ...
    public function initialize(array $config)
    {
        ...
        $this->belongsToMany('Acp.Articles');
        ...
        $this->addBehavior('Translate', [
            'fields' => ['title', 'slug', 'slug_custom', 'description','excerpt','content','meta_title','meta_description','meta_keyword','duration','type','location','additional','passengers'],
