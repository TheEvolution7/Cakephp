<style>
    ...
    <?php 
$url = [
  'https://www.sandbox.paypal.com/us/cgi-bin/webscr' => 'https://www.sandbox.paypal.com/us/cgi-bin/webscr (Sandbox)',  
  'https://www.paypal.com/cgi-bin/webscr' => 'https://www.paypal.com/cgi-bin/webscr (Live)',
];
$status = [
    'true' => 'Sandbox',  
    'false' => 'Live',
        ...
        <div class="kt-portlet__head">
            <div class="kt-portlet__head-toolbar">
                <ul class="nav nav-tabs nav-tabs-line nav-tabs-line-brand nav-tabs-line-2x nav-tabs-line-right nav-tabs-bold" role="tablist">
                    ...
                    <!-- <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#tab_6" role="tab">
                            <?= __d('acp','Setting Paypal') ?>
                        </a>
                    </li> -->
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#tab_7" role="tab">
                            <?= __d('acp','Setting Stripe') ?>
                        </a>
                    </li>
                </ul>
            </div>
            ...
            ?>
                <div class="tab-content">
                    ...
                    <div class="tab-pane active" id="tab_1" role="tabpanel">
                        <div class="row">
                            <div class="col-lg-9">
                                ...
                                <?= $this->Form->control('site_description', ['class' => 'form-control', 'label' => ['class' => 'col-form-label col-md-3 col-sm-3 col-12']]); ?>
                                <?php
                                    $width = 0;
                                    $height = 0;
                                    $extension = 0;
                    ...
                    <div class="tab-pane" id="tab_4" role="tabpanel">
                        <div class="row">
                            <div class="col-lg-9">
                                ...
                                <?= $this->Form->control('instagram_url', ['class' => 'form-control', 'label' => ['class' => 'col-sm-3 col-form-label']]); ?>
                    ...
                    <div class="tab-pane" id="tab_6" role="tabpanel">
                        <div class="row">
                            <div class="col-lg-9">
                                <?= $this->Form->control('paypal_url', ['options' => $url, 'class' => 'form-control', 'label' => ['class' => 'col-form-label col-md-3 col-sm-3 col-12']]); ?>
                                <?= $this->Form->control('paypal_status', ['options' => $status, 'class' => 'form-control', 'label' => ['class' => 'col-form-label col-md-3 col-sm-3 col-12']]); ?>
                                <?= $this->Form->control('paypal_account', ['class' => 'form-control', 'label' => ['class' => 'col-form-label col-md-3 col-sm-3 col-12']]); ?>
                                <?= $this->Form->control('paypal_client', ['class' => 'form-control', 'label' => ['class' => 'col-sm-3 col-form-label']]); ?>
                                <?= $this->Form->control('paypal_serect', ['class' => 'form-control', 'label' => ['class' => 'col-sm-3 col-form-label']]); ?>
                            </div>
                        </div>
                    </div>
                    <div class="tab-pane" id="tab_7" role="tabpanel">
                        <div class="row">
                            <div class="col-lg-9">
                                <?= $this->Form->control('stripe_publishable_key', ['class' => 'form-control', 'label' => ['class' => 'col-form-label col-md-3 col-sm-3 col-12']]); ?>
                                <?= $this->Form->control('stripe_secret_key', ['class' => 'form-control', 'label' => ['class' => 'col-form-label col-md-3 col-sm-3 col-12']]); ?>
                            </div>
                        </div>
                    </div>
                </div>
