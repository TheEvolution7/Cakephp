                    ...
                    <div class="tab-pane active" id="tab_1" role="tabpanel">
                        <div class="row">
                            <div class="col-lg-9">
                                ...
                                <!-- <?= $this->Form->control('articles._ids', [
                                    'options'       => $articles,
                                    'class'         => 'form-control kt-select2 select2 d-block',
                                    'label'         => ['class' => 'col-form-label col-md-3 col-sm-3 col-12'],
                                    'hiddenField'   => false,
                                ...
                                <?= $this->Form->control('duration', ['class' => 'form-control', 'label' => ['class' => 'col-form-label col-md-3 col-sm-3 col-12']]); ?>
                                <?= $this->Form->control('location', ['class' => 'form-control', 'label' => ['class' => 'col-form-label col-md-3 col-sm-3 col-12']]); ?>
                                <?= $this->Form->control('type', ['class' => 'form-control', 'label' => ['class' => 'col-form-label col-md-3 col-sm-3 col-12']]); ?>
                                <?= $this->Form->control('excerpt', ['class' => 'form-control', 'label' => ['class' => 'col-form-label col-md-3 col-sm-3 col-12']]); ?>
                                ...
                                <!-- <?= $this->Form->control('additional', ['class' => 'form-control', 'label' => ['text' => 'Price additional('.$this->getConfigure('Core')['setting']['currency'].')','class' => 'col-form-label col-md-3 col-sm-3 col-12'],'value' => $this->Cms->price_translate($product->additional,$product->currency,$this->getConfigure('Core')['setting']['currency'])]); ?>
                                <?= $this->Form->control('passengers', ['class' => 'form-control', 'label' => ['class' => 'col-form-label col-md-3 col-sm-3 col-12']]); ?> -->
