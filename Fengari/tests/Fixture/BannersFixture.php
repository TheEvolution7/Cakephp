...
class BannersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'banner_category_id' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8_unicode_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                'id' => 1,
                'banner_category_id' => 'Lorem ipsum dolor sit amet',
                'user_id' => 1,
                ...
                'status' => 1,
                'featured' => 1,
                'created' => '2019-03-06 13:58:59',
                'modified' => '2019-03-06 13:58:59'
            ],
        ];
        parent::init();
    }
