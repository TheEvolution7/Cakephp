                        ...
                        <div class="rev_slider_wrapper">
                            <div id="rev_slider" class="rev_slider tp-overflow-hidden fullscreenbanner">
                                <ul>
                                    ...
                                    <li data-transition='slideleft' data-slotamount='default' data-masterspeed="2000"
                                        data-fsmasterspeed="2000">
        
                                        <img src="<?= $this->Url->build('/uploads/banners/' . $banners[45][0]->id . DS . $banners[45][0]->image) ?>" data-bgparallax="5" alt=""
                                            data-bgposition="center 0" data-bgfit="cover" data-bgrepeat="no-repeat"
                                            class="rev-slidebg">
        
                                        <div class="tp-caption tp-shape __1 tp-shapewrapper  tp-resizeme" data-x="['left']"
                                            ...
                                            data-paddingleft="[0,0,0,0]" style="background-color:#5678bb;"> </div>
        
                                        <div class="tp-caption tp-shape __2 tp-shapewrapper  tp-resizeme" data-x="['left']"
                                        ...
                                        <div class="tp-caption tp-shape  __3 tp-shapewrapper  tp-resizeme" data-x="['left']"
                                            data-hoffset="['100']" data-y="['middle','middle','middle','middle']"
                                            ...
                                            data-textAlign="['left','left','left','left']" data-paddingtop="[0,0,0,0]"
                                            data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]"
                                            data-paddingleft="[0,0,0,0]" style="background-color:#6ec0a8;"> </div>
        
                                        <div class="tp-caption tp-shape  __4 tp-shapewrapper  tp-resizeme" data-x="['left']"
                                            data-hoffset="['100']" data-y="['middle','middle','middle','middle']"
                                            data-voffset="['19']" data-width="5" data-height="544" data-whitespace="nowrap"
                                            data-type="shape" data-responsive_offset="on"
                                        ...
                                        <div class="slider-title tp-caption tp-resizeme __1" data-x="['left']"
                                            data-hoffset="['156']" data-y="['middle','middle','middle','middle']"
                                            data-voffset="['-30']" data-textAlign="['left']"
                                            data-fontsize="['45', '32','24','20','16' ]" data-lineheight="['62','58', '42','34']"
                                            data-height="none" data-whitespace="nowrap" data-transform_idle="o:1;"
                                            data-transform_in="x:[-150%];z:0;rX:0deg;rY:0deg;rZ:0deg;sX:1;sY:1;skX:0;skY:0;s:2000;e:Power2.easeInOut;"
                                            data-transform_out="y:[100%];s:1000;e:Power2.easeInOut;s:1000;e:Power2.easeInOut;"
                                            data-mask_in="x:50px;y:0px;s:inherit;e:inherit;"
                                            data-mask_out="x:inherit;y:inherit;s:inherit;e:inherit;" data-start="500"
                                            data-splitin="" data-splitout="none" data-responsive_offset="on"
                                            data-elementdelay="0.05" style="font-weight:600; letter-spacing:-0.05em;"><?= $banners[45][0]->description ?>
                                        </div>
        
                                        <div class="slider-title tp-caption" data-x="['left']" data-hoffset="['156']"
                                            data-y="['middle','middle','middle','middle']" data-voffset="['-170']"
                                            data-textAlign="['left']" data-fontsize="['16']" data-lineheight="['20']"
                                            data-height="none" data-whitespace="nowrap" data-transform_idle="o:1;"
                                            data-transform_in="x:[155%];z:0;rX:0deg;rY:0deg;rZ:0deg;sX:1;sY:1;skX:0;skY:0;s:1500;e:Power2.easeInOut;"
                                            data-transform_out="y:[100%];s:1000;e:Power2.easeInOut;s:1000;e:Power2.easeInOut;"
                                            data-mask_in="x:50px;y:0px;s:inherit;e:inherit;"
                                            ...
                                            style="font-weight:600; letter-spacing:0.1em; text-transform:uppercase;"><?= $banners[45][0]->title ?>
                                        </div>
                                        ...
                                        <div class="slider-title tp-caption" data-x="['left']" data-hoffset="['156']"
                                            ...
                                            <a href="<?= $banners[45][0]->url ?>" class="link-arrow">See project <i
                                    ...
                                    <li data-transition='slideleft' data-slotamount='default' data-masterspeed="2000"
                                        ...
                                        <img src="<?= $this->Url->build('/uploads/banners/' . $banners[45][1]->id . DS . $banners[45][1]->image) ?>" data-bgparallax="5" alt=""
                                            data-bgposition="center 0" data-bgfit="cover" data-bgrepeat="no-repeat"
                                            class="rev-slidebg">
                                        ...
                                        <div class="slider-title tp-caption tp-resizeme __1" data-x="['left']"
                                            ...
                                            data-mask_out="x:inherit;y:inherit;s:inherit;e:inherit;" data-start="500"
                                            data-splitin="" data-splitout="none" data-responsive_offset="on"
                                            data-elementdelay="0.05" style="font-weight:600; letter-spacing:-0.05em;"><?= $banners[45][1]->description ?>
                                        </div>
                                        ...
                                        <div class="slider-title tp-caption" data-x="['left']" data-hoffset="['156']"
                                            ...
                                            data-splitin="chars" data-splitout="none" data-responsive_offset="on"
                                            data-elementdelay="0.05"
                                            style="font-weight:600; letter-spacing:0.1em; text-transform:uppercase;"><?= $banners[45][1]->title ?>
                                        </div>
                                        ...
                                        <div class="slider-title tp-caption" data-x="['left']" data-hoffset="['156']"
                                            ...
                                            data-splitin="none" data-splitout="none" data-responsive_offset="on"
                                            data-elementdelay="0.05" style="font-weight:600; ">
                                            <a href="<?= $banners[45][1]->url ?>" class="link-arrow">See project <i
                                                    class="icon ion-ios-arrow-thin-right"></i>
                                            </a>
                                        </div>
                                    </li>
                                    ...
                                    <li data-transition='slideleft' data-slotamount='default' data-masterspeed="2000"
                                        ...
                                        <img src="<?= $this->Url->build('/uploads/banners/' . $banners[45][2]->id . DS . $banners[45][2]->image) ?>" data-bgparallax="5" alt=""
                                            data-bgposition="center 0" data-bgfit="cover" data-bgrepeat="no-repeat"
                                            class="rev-slidebg">
                                        ...
                                        <div class="slider-title tp-caption tp-resizeme __1" data-x="['left']"
                                            ...
                                            data-mask_out="x:inherit;y:inherit;s:inherit;e:inherit;" data-start="500"
                                            data-splitin="" data-splitout="none" data-responsive_offset="on"
                                            data-elementdelay="0.05" style="font-weight:600; letter-spacing:-0.05em;"><?= $banners[45][2]->description ?>
                                        </div>
                                        ...
                                        <div class="slider-title tp-caption" data-x="['left']" data-hoffset="['156']"
                                            ...
                                            data-splitin="chars" data-splitout="none" data-responsive_offset="on"
                                            data-elementdelay="0.05"
                                            style="font-weight:600; letter-spacing:0.1em; text-transform:uppercase;"><?= $banners[45][2]->title ?>
                                        </div>
                                        ...
                                        <div class="slider-title tp-caption" data-x="['left']" data-hoffset="['156']"
                                            ...
                                            data-splitin="none" data-splitout="none" data-responsive_offset="on"
                                            data-elementdelay="0.05" style="font-weight:600; ">
                                            <a href="<?= $banners[45][2]->url ?>" class="link-arrow">See project <i
                                                    class="icon ion-ios-arrow-thin-right"></i>
                                            </a>
                                        </div>
                                    </li>
                                    ...
                                    <li data-transition='slideleft' data-slotamount='default' data-masterspeed="2000"
                                        ...
                                        <img src="<?= $this->Url->build('/uploads/banners/' . $banners[45][3]->id . DS . $banners[45][3]->image) ?>" data-bgparallax="5" alt=""
                                            data-bgposition="center 0" data-bgfit="cover" data-bgrepeat="no-repeat"
                                            class="rev-slidebg">
                                        ...
                                        <div class="slider-title tp-caption tp-resizeme __1" data-x="['left']"
                                            ...
                                            data-mask_out="x:inherit;y:inherit;s:inherit;e:inherit;" data-start="500"
                                            data-splitin="" data-splitout="none" data-responsive_offset="on"
                                            data-elementdelay="0.05" style="font-weight:600; letter-spacing:-0.05em;"><?= $banners[45][3]->description ?>
                                        </div>
                                        ...
                                        <div class="slider-title tp-caption" data-x="['left']" data-hoffset="['156']"
                                            ...
                                            data-splitin="chars" data-splitout="none" data-responsive_offset="on"
                                            data-elementdelay="0.05"
                                            style="font-weight:600; letter-spacing:0.1em; text-transform:uppercase;"><?= $banners[45][3]->title ?>
                                        </div>
                                    ...
                                    <li data-transition='slideleft' data-slotamount='default' data-masterspeed="2000"
                                        ...
                                        <img src="<?= $this->Url->build('/uploads/banners/' . $banners[45][4]->id . DS . $banners[45][4]->image) ?>" data-bgparallax="5" alt=""
                                            data-bgposition="center 0" data-bgfit="cover" data-bgrepeat="no-repeat"
                                            class="rev-slidebg">
                                        ...
                                        <div class="slider-title tp-caption tp-resizeme __1" data-x="['left']"
                                            ...
                                            data-mask_out="x:inherit;y:inherit;s:inherit;e:inherit;" data-start="500"
                                            data-splitin="" data-splitout="none" data-responsive_offset="on"
                                            data-elementdelay="0.05" style="font-weight:600; letter-spacing:-0.05em;"><?= $banners[45][4]->description ?>
                                        </div>
                                        ...
                                        <div class="slider-title tp-caption" data-x="['left']" data-hoffset="['156']"
                                            ...
                                            data-splitin="chars" data-splitout="none" data-responsive_offset="on"
                                            data-elementdelay="0.05"
                                            style="font-weight:600; letter-spacing:0.1em; text-transform:uppercase;"><?= $banners[45][4]->title ?>
                                        </div>
                    ...
                    <div class="content">
                        ...
                        <section class="section-about">
                            <div class="container">
                                <div class="row">
                                    <div class="col-md-6">
                                        <strong class="section-subtitle"><?= $banners[46][0]->title ?></strong>
                                        <?= $banners[46][0]->description ?>
                                    </div>
                                    <div class="col-md-5 col-md-offset-1">
                                        <div class="dots-image">
                                            <img alt="" class="about-img img-responsive" src="<?= $this->Url->build('/uploads/banners/' . $banners[46][0]->id . DS . $banners[46][0]->image) ?>">
                                            <div class="dots"></div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="project-carousel owl-carousel">
                                        	<?php foreach ($banners[47] as $banner): ?>
                                        		<div class="project-item item-shadow building">
	                                                <img alt="" class="img-responsive" src="<?= $this->Url->build('/uploads/banners/' . $banner->id . DS . $banner->image) ?>">
	                                                <div class="project-hover">
	                                                    <div class="project-hover-content">
	                                                        <h3 class="project-title"><?= $banner->title ?></h3>
	                                                        <p class="project-description"><?= $banner->description ?></p>
	                                                    </div>
	                                                </div>
	                                                <a href="<?= $banner->url ?>" class="link-arrow"><?= __('See project') ?><i class="icon ion-ios-arrow-right"></i></a>
	                                            </div>
                                        	<?php endforeach ?>
                        ...
                        <section class="section-process section">
                            <div class="container">
                                <div class="process-carousel owl-carousel">
                                	<?php foreach ($banners[48] as $banner): ?>
                                		<div class="process-carousel-item">
	                                        <div class="container">
	                                            <div class="row">
	                                                <div class="col-md-5 col-xs-12 d-flex align-items-center">
	                                                    <div class="content">
	                                                        <strong class="section-subtitle"><?= $banner->title ?></strong>
	                                                        <?= $banner->description ?>
	                                                        <a href="<?= $banner->url ?>"><?= __('More info') ?></a>
	                                                    </div>
                        ...
                        <section class="section-clients section bg-dots">
                            <div class="container">
                                <h2 class="section-title"><?= __('From Our Clients') ?></h2>
                                <div class="client-carousel owl-carousel">
                                	<?php foreach ($banners[49] as $banner): ?>
                                		<div class="client-carousel-item">
                                            <div class="client-img">
                                                <!-- <img alt="" src="<?= $this->Url->build('/uploads/banners/' . $banner->id . DS . $banner->image) ?>"> -->
                                                <img src="<?= $webroot ?>images/logo-2.png" class="logo-gray" alt="">
                                            </div>
	                                        
	                                        <div class="client-box">
	                                            <img alt="" class="image-quote" src="<?= $webroot ?>images/image-icons/icon-quote.png">
	                                            <div class="client-title">
	                                                <span class="client-name"><?= $banner->title ?></span>
	                                                <span class="client-company"><?= $banner->url ?></span>
	                                            </div>
	                                            <p class="client-description"><?= $banner->description ?></p>
	                                        </div>
	                                    </div>
                                	<?php endforeach ?>
                                </div>
                        ...
                        <section class="section-news section">
                            <div class="container">
                                <h2 class="section-title">Latest News <a href="<?= $this->Url->build(['controller' => 'Articles', 'action' => 'index']) ?>" class="link-arrow-2 pull-right">All Articles <i
                                	...
                                	<?php foreach ($articles as $article): ?>
                                		<div class="news-item">
	                                        ...
	                                        <div class="news-hover">
	                                            ...
	                                            <a class="read-more" href="<?= $this->Url->build(['controller' => 'Articles', 'action' => 'details', $article->slug, $article->id]) ?>">Continue</a>
	                                        </div>
	                                    </div>
                                	<?php endforeach ?>
                                </div>
                        ...
                        <section class="contact-home section" style="background-image: url(<?= $webroot ?>images/new-img.jpeg);">
                            <div class="container">
                                <div class="row">
                                    <div class="box-content">
                                        <h2 class="section-title">Let's talk about <span>your</span> project.</h2>
                                        <a href="contact.html" class="btn-upper btn-dark btn">Get Started</a>
                                    </div>
