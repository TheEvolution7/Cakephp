        ...
        <div class="kt-portlet__body kt-portlet__body--fit">
            <div class="kt-form kt-form--label-right">
                <div class="kt-portlet__body">
                    ...
                    <?php foreach (unserialize($contact->data) as $key => $value): ?>
                        <div class="form-group form-group-xs row">
                            <label class="col-2 col-form-label"><?= ucfirst($key) ?>:</label>
                            <div class="col-9">
                                <span class="form-control-plaintext kt-font-bolder"><?= h($value) ?></span>
                            </div>
                        </div>
                    <?php endforeach ?>
                </div>
