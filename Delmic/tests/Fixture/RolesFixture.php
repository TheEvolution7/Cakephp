...
class RolesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'alias' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8_unicode_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'color' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8_unicode_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'status' => 1,
                'created' => '2019-02-24 02:20:52',
                'modified' => '2019-02-24 02:20:52'
            ],
        ];
        parent::init();
    }
