...
Router::scope('/', function (RouteBuilder $routes) {
    ...
    $routes->connect('/team', ['controller' => 'Pages', 'action' => 'team'], ['routeClass' => 'ADmad/I18n.I18nRoute']);
    $routes->connect('/team', ['controller' => 'Pages', 'action' => 'team']);

    $routes->connect('/services', ['controller' => 'Pages', 'action' => 'service'], ['routeClass' => 'ADmad/I18n.I18nRoute']);
    $routes->connect('/services', ['controller' => 'Pages', 'action' => 'service']);

    // Article
    
    // $routes->connect(
    //     '/properties/',
    //     ['controller' => 'Articles', 'action' => 'properties'], ['routeClass' => 'ADmad/I18n.I18nRoute']
    // );
    // $routes->connect(
    //     '/properties/',
    //     ['controller' => 'Articles', 'action' => 'properties']
    // );

    
    $routes->connect(
        '/properties/category/:slug-:id',
