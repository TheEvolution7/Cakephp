                ...
                <div class="projects-list-img mb_6 pl_6 pr_6 pb_6 pt_6 flex_ae pos_r o_h z_1">
                    ...
                    <div class="flex_ac c_w">
                        ...
                        <div class="lh_110 pb_2">
                            ...
                            <div class="fz24 o_h">
                                <div class="projects-list-param"><?= explode('|', $album->description)[1] ?></div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <?php foreach (explode(',', $album->attribute) as $attribute): ?>
                        ...
                        <div class="pt_2 pb_2">
                            <div class="flex_jsb o_h">
                                <div class="projects-list-param"><?= $str[0] ?></div>
                                <div class="projects-list-param"><?= $str[1] ?></div>
                            </div>
                        </div>
