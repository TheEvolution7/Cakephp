                            ...
                            <div class="col-lg-9">
                                ...
                                <?php
                                    ...
                                    if (!empty($currency->image)) {
                                        ...
                                        $imagePath = 'uploads' . DS . 'currencys' . DS . $currency->id . DS . $currency->image;
                                ...
                                <?= $this->Form->control('rate', ['class' => 'form-control', 'label' => ['class' => 'col-form-label col-md-3 col-sm-3 col-12']]); ?>
                                <?= $this->Form->control('currency', ['class' => 'form-control', 'label' => ['class' => 'col-form-label col-md-3 col-sm-3 col-12']]); ?>
