                        ...
                        <div class="row">
                            <div class="col-lg-9">
                                ...
                                <?php
                                    ...
                                    if (!empty($pageCategory->image)) {
                                        
                                        $imagePath = 'uploads' . DS . 'pageCategorys' . DS . $pageCategory->id . DS . $pageCategory->image;
