    ...
    <div class="kt-portlet kt-portlet--tabs">
        ...
        <div class="kt-portlet__body">
            ...
            ?>
                    ...
                    <div class="tab-pane active" id="tab_1" role="tabpanel">
                        <div class="row">
                            <div class="col-lg-9">
                                ...
                                <?= $this->Form->control('album_categories._ids', [
                                ...
                                <?php
                                    ...
                                    if (!empty($album->image)) {
                                        ...
                                        $imagePath = 'uploads' . DS . 'albums' . DS . $album->id . DS . $album->image;
                                    ...
                                    if ($width > 500) {
                                        $imagePath = 'uploads' . DS . 'albums' . DS . $album->id . DS . 'thumbnail' . DS . $album->image;
                                    }
                                ?>
                                ...
                                <?= $this->Form->control('attribute', ['class' => 'form-control', 'label' => ['class' => 'col-form-label col-md-3 col-sm-3 col-12']]); ?>
                                <?= $this->Form->control('map', ['class' => 'form-control', 'label' => ['class' => 'col-form-label col-md-3 col-sm-3 col-12']]); ?>
                    ...
                    <div class="tab-pane" id="tab_2" role="tabpanel">
                        <div class="col-12">
                            <div class="row portfolio-grid">
                                <?php foreach ($album->album_images as $key => $image): ?>
                                        ...
                                        <figure class="effect-text-in position-relative w-100 align-self-stretch hover-figure">
                                            <?php 
                                                if (!empty($image->image)) {
                                                    $imagePath = 'uploads' . DS . 'albums' . DS . $album->id . DS .$image->image;
                                                    ...
                                                    if ($width > 500) {
                                                        $imagePath = 'uploads' . DS . 'albums' . DS . $album->id . DS . 'thumbnail' . DS . $image;
                                                    }
                                            ...
                                            ?>
                                            <figcaption>
                                                <?php if ($album->image == $image->image): ?>
                                                ...
                                                <p class="mb-0 d-flex justify-content-between position-absolute fixed-bottom w-100 p-3 bg-primary hide-el">
                                                    ...
                                                    <button type="button" data-url="<?= $this->Url->build(['controller' => 'Albums','action' => 'jGetImage',$image->id]) ?>" class="btn btn-inverse-dark btn-edit" data-toggle="modal" data-target="#image-modal"><i class="fa fa-edit"></i></button>
                                                    <button type="button" data-url="<?php echo $this->Url->build(DS . $imagePath) ?>" data-url-remove="<?php echo $this->Url->build('/acp/'.$this->request['controller'].'/jRemoveImage') ?>" id-image="<?=  $image->id ?>" class="btn btn-inverse-dark btn-remove"><i class="fa fa-trash"></i></button>
                                                </p>
                                            </figcaption>
                                        </figure>
                                    </div>
                ...
                <input type="hidden" name="image" value="<?php echo $album->image ?>">
                <input type="hidden" name="image_fix" value="<?php echo $album->image ?>">
                <input type="hidden" name="images" value="<?php echo $album->images ?>">
                <input type="hidden" name="images_delete">
                <input type="hidden" name="id_dir" value="<?php echo isset($album->id)?$album->id:0?>">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="ModalLabel"><?php echo __d('acp', 'Edit Image') ?></h5>
            ...
            <div class="modal-body">
                <form id="content-image">
                    <input type="hidden" name="id" id="id-image">
                    <input type="hidden" name="id" id="id-image">
                    <div class="form-group">
                        <label class="col-form-label"><?php echo __d('acp', 'Title') ?>:</label>
                        <input type="text" class="form-control" name="title" id="title-image">
                    </div>
                    <div class="form-group">
                        <label class="col-form-label"><?php echo __d('acp', 'Description') ?>:</label>
                        <textarea class="form-control" name="description" id="description-image"></textarea>
                    </div>
                </form>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-success" id="save-content-image" data-url="<?php echo $this->Url->build('/acp/'.$this->request['controller'].'/jSaveImage') ?>"><?php echo __d('acp', 'Save change') ?></button>
