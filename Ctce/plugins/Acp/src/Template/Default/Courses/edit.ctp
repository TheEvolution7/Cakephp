                        ...
                        <div class="row">
                            <div class="col-lg-9">
                                ...
                                <?= $this->Form->control('type', [
                                    'options'       => ['optional' => 'Qptional', 'lesson' => 'Lesson', 'quiz' => 'Quiz', 'feedback' => 'Feedback', 'certificate' => 'Certificate'],
                                ...
                                <?= $this->Form->control('body', ['class' => 'form-control editor', 'label' => ['class' => 'col-form-label col-md-3 col-sm-3 col-12']]); ?>
                                <?= $this->Form->control('rule', ['class' => 'form-control', 'label' => ['class' => 'col-form-label col-md-3 col-sm-3 col-12']]); ?>
