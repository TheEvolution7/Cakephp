                        ...
                        <div class="row">
                            <div class="col-lg-9">
                                ...
                                <!-- <?= $this->Form->control('quiz_id', [
                                    ...
                                    'hiddenField'   => false,
                                    'value' => $this->request->getQuery('quiz_id'),
                                    'empty'         => 'Select Category'
                                ]); ?> -->
                                <?= $this->Form->control('quiz_question_id', [
                                    'options'       => $quizQuestions,
                                    'class'         => 'form-control kt-select2 select2',
                                    'label'         => ['class' => 'col-form-label col-md-3 col-sm-3 col-12'],
                                    'hiddenField'   => false,
                                    'value' => $this->request->getQuery('quiz_question_id'),
                                    'empty'         => 'Select Category'
                                ]); ?>

                                <?= $this->Form->control('content', ['class' => 'form-control', 'label' => ['class' => 'col-form-label col-md-3 col-sm-3 col-12']]); ?>

                                <?= $this->Form->control('feedback', ['class' => 'form-control', 'label' => ['class' => 'col-form-label col-md-3 col-sm-3 col-12']]); ?>
