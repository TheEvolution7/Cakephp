$('.mm-prev-btn').css('opacity', 0);
$('.mm-next-btn').css('pointer-events', 'none');
	var x;
	var count;
	var current;
	var percent;
	...
	function getButtons() {
		...
		if(current === count) {
            ...
            $('.mm-next-btn').css('pointer-events', 'all');
            $('.mm-prev-btn').css('pointer-events', 'all');
			$('.mm-next-btn').css('opacity', 1);
			$('.mm-prev-btn').css('opacity', 1);
		}
