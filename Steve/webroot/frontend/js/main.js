...
//end of IIFE function
	...
	////////////////////
// our-product
/* var swiper = new Swiper('.our-pro-slide', {
	slidesPerView: 3,
	spaceBetween: 30,
	loop: true,
...
var swipertime = new Swiper('.swiper-milestone', {
	slidesPerView: 3,
	spaceBetween: 10,
	autoHeight: true,
	pagination: {
...
// our partner
var swiper = new Swiper('.our-partner-slide', {
	slidesPerView: 5,
	spaceBetween: 30,
	loop: true,
	loopFillGroupWithBlank: true,
...
var galleryThumbs = new Swiper('.gallery-pro-thumbs', {
    spaceBetween: 10,
    slidesPerView: 4,
    freeMode: true,
  ...
  var galleryTop = new Swiper('.gallery-pro-top', {
    spaceBetween: 10,
    thumbs: {
...
$(".link_img_pro").click(function() {
	var $this= $(this)
    $(".img-pro").fadeOut(300, function() {
        $(".img-pro").attr("src",$($this).attr("data-img"));
    }).fadeIn(300);
});

$(".link_img_about").click(function() {
	var $this= $(this)
    $(".img-about").fadeOut(300, function() {
        $(".img-about").attr("src",$($this).attr("data-img"));
    }).fadeIn(300);
});
