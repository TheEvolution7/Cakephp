...
class ProductsController extends AppController
{
    ...
    public function edit($id = null)
    {
        ...
        $product = $this->Products->get($id, [
            'contain' => ['Tags','AttributeValues','ProductCategories','AttributeValuesAmounts']
        ]);
        ...
        foreach ($attributes as $key => $attribute) {
            ...
            $lists = $this->Products->AttributeValues->find('list',['keyField' => 'id','valueField' => 'color','conditions' => ['status' => 1,'AttributeValues.id IN' => $arr_id]]);
        ...
        $users = $this->Products->Users->find('list', ['limit' => 200]);
        $this->set(compact('product', 'productCategories', 'users', 'tags','list_attribute','brands'));
    }
