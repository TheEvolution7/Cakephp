...
<div class="outer__container">
        ...
        <div class="box-slide-home" data-aos="animation-translate-up" data-aos-delay="300">
            <div class="banner__slide">
                <div class="banner-item">
                    <img src="<?= $this->Url->build('/uploads/banners/' . $banners[81][0]->id . DS . $banners[81][0]->image ) ?>" alt="<?= $banners[81][0]->title ?>">
                </div>
            </div>
        </div>
        <div class="main2__center center content-banner">
            <div class="main2__wrap" data-aos="animation-scale-top" data-aos-delay="300">
                <h1 class="main2__title h4" data-aos="animation-scale-top"><?= $banners[81][0]->title ?></h1>
                <div class="main2__info info" data-aos="animation-scale-top" data-aos-delay="300">
                <?= $banners[81][0]->description ?>
                </div>
                <div class="main2__btns" data-aos="animation-scale-top" data-aos-delay="500">
                    <a href="<?= $banners[81][0]->url ?>" type="submit" class="main2__btn btn btn_blue">Get Started Now</a>
                </div>
            </div>
        </div>
    </div>
    <div class="advantages2 how-it-section bg-2">
            <div class="advantages2__center center">
                <h2 class="how__title h2" data-aos="animation-scale-top"><?= $banners[82][0]->title ?></h2>
            </div>
        </div>
        <div class="advantages how-it-section_bg bg-2">
            <div class="advantages__center center">
                <div class="advantages__row">
                    <div class="advantages__bg"><img class="some-icon" srcset="<?= $this->Url->build('/uploads/banners/' . $banners[82][1]->id . DS . $banners[82][1]->image ) ?>"
                        src="<?= $this->Url->build('/uploads/banners/' . $banners[82][1]->id . DS . $banners[82][1]->image ) ?>" alt="<?= $banners[82][1]->title ?>">
                    </div>
                    <div class="advantages__wrap">
                        <h5 class="advantages__title h5" data-aos="animation-scale-top"><?= $banners[82][1]->title ?></h5>
                        <div class="advantages__info info" data-aos="animation-scale-top">
                            <?= $banners[82][1]->description ?>
                        </div>
                        <a href="<?= $banners[82][1]->url ?>" class="faq__btn btn btn_blue-light" data-aos="animation-scale-top">Get started</a>
                    </div>
                </div>
                <div class="advantages__row">
    ...
    <div class="faq bg-3">
        <div class="faq__center center">
            <div class="faq__top">
            <h2 class="faq__title h2" data-aos="animation-scale-top"><?= $banners[80][0]->title ?></h2>   
            </div>
            <div class="faq__row">
            <div class="faq__col">
            <?php foreach($banners[83] as $k => $banner): if($k%2 == 0): ?>
                <div class="faq__item">
