 ...
 <div class="outer__container">
          ...
          <h1 class="main2__title h4" data-aos="animation-scale-top"><?= $banners[24][0]->title ?></h1>
            ...
            <form action="<?= $this->Url->build(['controller' => 'Pages','action' => 'newsletter']) ?>" method="post">
              ...
              <div class="main2__btns" data-aos="animation-scale-top" data-aos-delay="500">
                <button type="submit" class="main2__btn btn btn_blue">Get Started Now</button>
              </div>
            </form>
          </div>
        </div>
      ...
      <div class="advantages2 how-it-section bg-2">
            <div class="advantages2__center center">
                <h2 class="how__title h2" data-aos="animation-scale-top"><?= $banners[106][0]->title ?></h2>
            </div>
        </div>
        <div class="advantages how-it-section_bg bg-2">
            <div class="advantages__center center">
                <div class="advantages__row">
                    <div class="advantages__bg"><img class="some-icon" srcset="<?= $this->Url->build('/uploads/banners/' . $banners[106][1]->id . DS . $banners[106][1]->image ) ?>"
                        src="<?= $this->Url->build('/uploads/banners/' . $banners[106][1]->id . DS . $banners[106][1]->image ) ?>" alt="<?= $banners[106][1]->title ?>">
                    </div>
                    <div class="advantages__wrap">
                        <h5 class="advantages__title h5" data-aos="animation-scale-top"><?= $banners[106][1]->title ?></h5>
                        <div class="advantages__info info" data-aos="animation-scale-top">
                            <?= $banners[106][1]->description ?>
                        </div>
                        <a href="<?= $banners[106][1]->url ?>" class="faq__btn btn btn_blue-light" data-aos="animation-scale-top">Get started</a>
                    </div>
                </div>
                <div class="advantages__row">
      ...
      <div class="faq bg-3">
            <div class="faq__center center">
                <div class="faq__top">
                <h2 class="faq__title h2" data-aos="animation-scale-top"><?= $banners[104][0]->title ?></h2>   
                </div>
                <div class="faq__row">
                <div class="faq__col">
                <?php foreach($banners[107] as $k => $banner): if($k%2 == 0): ?>
                    <div class="faq__item">
