                    ...
                    <?php foreach ($appointments as $appointment): ?>
                      <?php if (!empty($appointment->stripe_status)): ?>
                        <tr>
                            ...
                            <td data-label="Consult details"><?= json_decode($appointment->stripe_status, true)['data']['object']['charges']['data'][0]['payment_method_details']['card']['brand'] .' ' . json_decode($appointment->stripe_status, true)['data']['object']['charges']['data'][0]['payment_method_details']['card']['funding'] . ' ' . 'card' ; ?></td>
