        ...
        <div class="kt-portlet__body kt-portlet__body--fit">
            <div class="kt-form kt-form--label-right">
                <div class="kt-portlet__body">
                    ...
                    <div class="form-group form-group-xs row">
                        <label class="col-2 col-form-label"><?= __d('acp','Speciality') ?>:</label>
                        <div class="col-9">
                            <span class="form-control-plaintext kt-font-bolder"><?= h($contact->title) ?></span>
                        </div>
                    </div>
                    <div class="form-group form-group-xs row">
                        <label class="col-2 col-form-label"><?= __d('acp','Region(s) of Licensure') ?>:</label>
                        <div class="col-9">
                            <span class="form-control-plaintext kt-font-bolder"><?= h($contact->address) ?></span>
                        </div>
                    </div>
                    <div class="form-group form-group-xs row">
                        <label class="col-2 col-form-label"><?= __d('acp','How did you hear about us?') ?>:</label>
                        <div class="col-9">
                            <span class="form-control-plaintext kt-font-bolder"><?= h($contact->about) ?></span>
                        </div>
                    </div>
                    <div class="form-group form-group-xs row">
                        <label class="col-2 col-form-label"><?= __d('acp','Physician College Online Listing (optional)') ?>:</label>
                        <div class="col-9">
