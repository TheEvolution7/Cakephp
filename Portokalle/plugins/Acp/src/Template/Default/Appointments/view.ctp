                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="kt-section">
                                ...
                                <h3><?= $this->Html->link('Practitioner Details', ['controller' => 'Personals', 'action' => 'edit', $appointment->personal->id]) ?></h3>
                                <hr>
                                <span class="kt-section__info">Practitioner: <b><?= $appointment->personal->title . ' ' . $appointment->personal->forename . ' ' . $appointment->personal->surname ?></b></span>
