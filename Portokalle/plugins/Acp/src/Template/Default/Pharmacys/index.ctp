                    ...
                    <table class="table table-striped">
                        <thead>
                            <tr class="text-center">
                                ...
                                <th><?= __d('acp','Latitude')?></th>
                                <th><?= __d('acp','Longitude')?></th>
                        ...
                        <tbody>
                            ...
                            <?php foreach ($pharmacys as $pharmacy): ?>
                                <tr data-id="<?= $pharmacy->id?>" class="text-center">
                                    <th scope="row"><?= $this->Number->format($pharmacy->id) ?></th>
                                    <td><?= h($pharmacy->name) ?></td>
                                    <td><?= h($pharmacy->latitude) ?></td>
                                    <td><?= h($pharmacy->longitude) ?></td>
                                    <td><?= $pharmacy->created ?></td>
                                    <td><?= $this->Element('Acp.Core' . DS . 'action', ['except' => [],'id' => $pharmacy->id]) ?></td>
                                    <td>
                                        <label class="kt-checkbox kt-checkbox--single kt-checkbox--solid no-mg">
