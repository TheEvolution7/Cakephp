                            ...
                            <div class="col-lg-9">
                                ...
                                <?php
                                    ...
                                    if (!empty($pharmacy->image)) {
                                        ...
                                        $imagePath = 'uploads' . DS . 'pharmacys' . DS . $pharmacy->id . DS . $pharmacy->image;
                                ...
                                ?>
                                <?= $this->Form->control('name', ['class' => 'form-control', 'label' => ['class' => 'col-form-label col-md-3 col-sm-3 col-12']]); ?>
