					...
					<div class="kt-widget kt-widget--user-profile-1">
						...
						<div class="kt-widget__body">
							<div class="kt-widget__items">
								<a href="<?= $this->Url->build(['controller' => 'Records', 'action' => 'index', '?' => ['doctor_id' => $user->id]]) ?>" class="kt-widget__item" target="_blank">
								...
								<a href="<?= $this->Url->build(['controller' => 'Patients', 'action' => 'index', '?' => ['doctor_id' => $user->id]]) ?>" class="kt-widget__item " target="_blank">
									<span class="kt-widget__section">
										<span class="kt-widget__icon">
											<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
												<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
								...
								<a href="<?= $this->Url->build(['action' => 'customers', '?' => ['user_id' => $user->id]]) ?>" class="kt-widget__item ">
									<span class="kt-widget__section">
										<span class="kt-widget__icon">
											<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
												<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
								...
								<a href="<?= $this->Url->build(['action' => 'doctorStatements', $user->id]) ?>" class="kt-widget__item">
									<span class="kt-widget__section">
										<span class="kt-widget__icon">
											<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
												<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
							...
							<div class="kt-form__body">
								<div class="kt-section kt-section--first">
									<div class="kt-section__body">
										...
										<!-- <div class="form-group row">
											<label class="col-xl-3 col-lg-3 col-form-label">Clinic/Practice</label>
											<div class="col-lg-9 col-xl-6">
												<div class="input-group">
													<?= $this->Form->text('doctor.clinic', ['class' => 'form-control']); ?>
												</div>
											</div>
										</div>
										<div class="form-group row">
											<label class="col-xl-3 col-lg-3 col-form-label">License doctor/ DEA/NPI</label>
											<div class="col-lg-9 col-xl-6">
												<div class="input-group">
													<?= $this->Form->text('doctor.license', ['class' => 'form-control']); ?>
												</div>
											</div>
										</div>
										<div class="form-group row">
											<label class="col-xl-3 col-lg-3 col-form-label">Specialty</label>
											<div class="col-lg-9 col-xl-6">
												<div class="input-group">
													<?= $this->Form->text('doctor.specialty', ['class' => 'form-control']); ?>
												</div>
											</div>
										</div>
										<div class="form-group row">
											...
											<div class="col-lg-9 col-xl-6">
												<div class="input-group">
													<?= $this->Form->textArea('profile', ['class' => 'form-control']); ?>
												</div>
											</div>
										</div> -->
									</div>
