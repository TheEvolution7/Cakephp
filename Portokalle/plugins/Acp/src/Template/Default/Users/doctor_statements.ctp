		...
		<div class="col-lg-8 col-xl-8 order-lg-1 order-xl-1">
				...
				<div class="kt-portlet__body kt-portlet__body--fluid">
					<div class="kt-widget20">
						<div class="kt-widget20__content kt-portlet__space-x">
							<span class="kt-widget20__number kt-font-brand">US$<?= $totalOrdersTime ?></span>
						</div>
			...
			<div class="kt-portlet kt-portlet--fit kt-portlet--head-noborder kt-portlet--height-fluid-half">
				...
				<div class="kt-portlet__body kt-portlet__body--fluid">
					<div class="kt-widget20">
						<div class="kt-widget20__content kt-portlet__space-x">
							<span class="kt-widget20__number kt-font-danger">US$<?= $totalOrderByThisMonth ?></span>
						</div>
						<div class="kt-widget20__chart" style="height:130px;">
			...
			<div class="kt-portlet kt-portlet--height-fluid">
				<div class="kt-widget14">
					<div class="kt-widget14__header kt-margin-b-30">
						...
						<span class="kt-widget20__number kt-font-brand">US$<?= $totalOrder ?></span>
					</div>
	...
	var KTDashboard = function() {
	    var bandwidthChart1 = function() {
	        ...
	        var config = {
	            type: 'line',
	            data: {
	                labels: <?= json_encode(array_keys($ordersTime)) ?>,
	                datasets: [{
	                    label: "Orders",
	                    ...
	                    //fill: 'start',
	                    data: <?= json_encode(array_values($ordersTime)) ?>
	                }]
	            },
	            options: {
	                title: {
	    ...
	    var bandwidthChart2 = function() {
	        ...
	        var config = {
	            type: 'line',
	            data: {
	                labels: <?= json_encode(array_keys($ordersDate)) ?>,
	                datasets: [{
	                    label: "Orders",
	                    backgroundColor: gradient,
	                    ...
	                    //fill: 'start',
	                    data: <?= json_encode(array_values($ordersDate)) ?>
	                }]
	            },
	            options: {
	                title: {
	    ...
	    var dailySales = function() {
	        ...
	        var chartData = {
	            labels: <?= json_encode(array_keys($ordersMonth)) ?>,
	            datasets: [{
	                //label: 'Dataset 1',
	                backgroundColor: KTApp.getStateColor('success'),
	                data: <?= json_encode(array_values($ordersMonth)) ?>
	            }]
	        };
	    ...
	    var profitShare = function() {        
	        ...
	        var config = {
	            ...
	            data: {
	                datasets: [{
	                    data: <?= json_encode($data_users_gender) ?>,
	                    backgroundColor: [
	    ...
	    var revenueChange = function() {
	        ...
	        Morris.Donut({
	            ...
	            data: <?= json_encode($data_orders_country) ?>,
	            colors: [
	                KTApp.getStateColor('success'),
	                KTApp.getStateColor('danger'),
	                KTApp.getStateColor('brand')
