                                    ...
                                    <div class="kt-form__body">
                                        <div class="kt-section kt-section--first">
                                            <div class="kt-section__body">
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-xl-3 col-lg-3 col-form-label"><?= $this->Form->label('content') ?></label>
                                                    <div class="col-lg-9 col-xl-6">
                                                        <?= $this->Form->textarea('content', ['class' => 'form-control']); ?>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-xl-3 col-lg-3 col-form-label"><?= $this->Form->label('price') ?></label>
                                                    <div class="col-lg-9 col-xl-6">
                                                        <?= $this->Form->number('price', ['class' => 'form-control']); ?>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-xl-3 col-lg-3 col-form-label"><?= $this->Form->label('type') ?></label>
                                                    <?php
                                                    $myTemplates = [
                                                    ...
                                                    ?>
                                                    <div class="col-lg-9 col-xl-6">
                                                        <?= $this->Form->select('type', ['book' => 'book', 'as_soon_as' => 'as_soon_as'], ['empty' => 'Select', 'class' => 'form-control']); ?>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-xl-3 col-lg-3 col-form-label"><?= $this->Form->label('duration') ?></label>
                                                    <div class="col-lg-9 col-xl-6">
                                                        <?= $this->Form->text('duration', ['class' => 'form-control']); ?>
                                                    </div>
                                                </div>
                                                <?php
                                                $myTemplates = [
                                                    'select' => '<select name="{{name}}" {{attrs}}>{{content}}</select>',
                                                    'nestingLabel' => '{{hidden}}<label{{attrs}}>{{input}}{{text}}<span></span></label>',
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-xl-3 col-lg-3 col-form-label"><?= $this->Form->label('order') ?></label>
                                                    <div class="col-lg-9 col-xl-6">
                                                        <?= $this->Form->text('order', ['class' => 'form-control']); ?>
                                                    </div>
                                                </div>
                                                <div class="form-group form-group-last row">
                                                    <label class="col-form-label col-md-3 col-sm-3 col-12"><?= __d('acp','All Status') ?></label>
