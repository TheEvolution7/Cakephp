                                    ...
                                    <div class="kt-form__body">
                                        <div class="kt-section kt-section--first">
                                            <div class="kt-section__body">
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-xl-3 col-lg-3 col-form-label"><?= $this->Form->label('date_of_birth') ?></label>
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-xl-3 col-lg-3 col-form-label"><?= $this->Form->label('sex') ?></label>
                                                    <?php
                                                    $myTemplates = [
                                                    ...
                                                    ?>
                                                    <div class="col-lg-9 col-xl-6">
                                                        <?= $this->Form->select('sex', ['Female', 'Male', 'Intersex'], ['empty' => 'Select', 'class' => 'form-control']); ?>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-xl-3 col-lg-3 col-form-label"><?= $this->Form->label('health_card') ?></label>
                                                    <div class="col-lg-9 col-xl-6">
                                                        <?= $this->Form->text('health_card', ['class' => 'form-control']); ?>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-xl-3 col-lg-3 col-form-label"><?= $this->Form->label('health_card_province') ?></label>
                                                    <div class="col-lg-9 col-xl-6">
                                                        <?= $this->Form->text('health_card_province', ['class' => 'form-control']); ?>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9 col-xl-6">
                                                        <div class="kt-section__content d-flex flex-wrap">
                                                            ...
                                                            <?php if (!empty($patient->attachments)): ?>
                                                                <?php $str =  explode(',', $patient->attachments); unset($str[count($str) - 1])?>
                                                                <?php foreach ($str as $img): ?>
                                                                    <span class="kt-userpic kt-margin-r-5 kt-margin-t-5">
                                                                       <img src="<?= $this->Url->build(DS . 'uploads' . DS . 'patients' . DS . $patient->id . DS . 'thumbnail' . DS . $img) ?>">
                                                                    </span> 
