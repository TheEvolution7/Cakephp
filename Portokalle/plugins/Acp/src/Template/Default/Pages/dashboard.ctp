                                            ...
                                            <div class="kt-widget5__pic">
                                                <?php 
                                                    if (!empty($product->image)) {
                                                        $imagePath = DS . 'uploads' . DS . 'products' . DS . $product->id . DS .$product->image;
                                                    } else {
                                                        $imagePath = DS . 'img/no_thumb.png';
                                                    }
                                                ?>
                                            ...
                                            <div class="kt-widget5__pic">
                                                <?php 
                                                    if (!empty($article->image)) {
                                                        $imagePath = DS . 'uploads' . DS . 'articles' . DS . $article->id . DS .$article->image;
                                                    } else {
                            ...
                            <div class="kt-widget5">
                                <?php foreach ($orders as $order): ?>
                                    <div class="kt-widget5__item">
                                        ...
                                        <div class="kt-widget5__content">
                                            <div class="kt-widget5__stats">
                                                <span class="kt-widget5__number">$ <?= $order->amount ?></span>
