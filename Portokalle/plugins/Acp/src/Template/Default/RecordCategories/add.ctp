...
<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
    ...
    <div class="kt-portlet kt-portlet--tabs">
        ...
        <div class="kt-portlet__body">
             <?= $this->Form->create($recordCategory, [
                'type' => 'file',
                'templates' => [
                        ...
                        <div class="row">
                            <div class="col-lg-9">
                                ...
                                <?php
                                    ...
                                    if (!empty($recordCategory->image)) {
                                        
                                        $imagePath = 'uploads' . DS . 'recordCategorys' . DS . $recordCategory->id . DS . $recordCategory->image;
