<?php 
	...
	$menus = [
        ...
        __d('acp', 'Appointments') => [
            'icon' => '<i class="kt-menu__link-icon flaticon2-menu-2"></i>',
            'title' => __d('acp', 'Appointments'),
            'url' => ['plugin' => 'Acp', 'controller' => 'Appointments', 'action' => 'index'],
            'submenu' => [
             [
                    'url' => ['plugin' => 'Acp', 'controller' => 'Appointments', 'action' => 'index'],
                    'title' => __d('acp', 'Appointment List')
                ]
            ]
        ],
        __d('acp', 'Personals') => [
            'icon' => '<i class="kt-menu__link-icon flaticon2-image-file"></i>',
            'title' => __d('acp', 'Personals'),
            'url' => ['plugin' => 'Acp', 'controller' => 'Personals', 'action' => 'index'],
            'submenu' => [
             [
                    'url' => ['plugin' => 'Acp', 'controller' => 'Personals', 'action' => 'index'],
                    'title' => __d('acp', 'Personals')
        ...
        __d('acp', 'Practice Hours') => [
            'icon' => '<i class="kt-menu__link-icon flaticon2-expand"></i>',
            'title' => __d('acp', 'Practice Hours'),
            'url' => ['plugin' => 'Acp', 'controller' => 'PracticeHours', 'action' => 'index'],
            'submenu' => [
             [
                    'url' => ['plugin' => 'Acp', 'controller' => 'PracticeHours', 'action' => 'index'],
                    'title' => __d('acp', 'Practice Hours')
        ...
        __d('acp', 'Speciality') => [
            'icon' => '<i class="kt-menu__link-icon flaticon2-expand"></i>',
            'title' => __d('acp', 'Speciality'),
            'url' => ['plugin' => 'Acp', 'controller' => 'Specialities', 'action' => 'index'],
            'submenu' => [
             [
                    'url' => ['plugin' => 'Acp', 'controller' => 'Specialities', 'action' => 'index'],
                    'title' => __d('acp', 'Speciality')
        ...
        __d('acp', 'Services') => [
            'icon' => '<i class="kt-menu__link-icon flaticon2-expand"></i>',
            'title' => __d('acp', 'Services'),
            'url' => ['plugin' => 'Acp', 'controller' => 'Services', 'action' => 'index'],
            'submenu' => [
             [
                    'url' => ['plugin' => 'Acp', 'controller' => 'Services', 'action' => 'index'],
                    'title' => __d('acp', 'Services')
  ...
  //       ],
        ...
        __d('acp', 'Records') => [
            'icon' => '<i class="kt-menu__link-icon flaticon-notepad"></i>',
            'title' => __d('acp', 'Records'),
            'url' => ['plugin' => 'Acp', 'controller' => 'Records', 'action' => 'index'],
            'submenu' => [
                [
                    'url' => ['plugin' => 'Acp', 'controller' => 'Records', 'action' => 'index'],
                    'title' => __d('acp', 'All Records')
                ],
                [
                    'url' => ['plugin' => 'Acp', 'controller' => 'RecordCategories', 'action' => 'index'],
                    'title' => __d('acp', 'All Record Category')
                ],
                // [
                //     'url' => ['plugin' => 'Acp', 'controller' => 'Patients', 'action' => 'index'],
                //     'title' => __d('acp', 'All Patients')
                // ]
            ]
        ],
        __d('acp', 'Patients') => [
            'icon' => '<i class="kt-menu__link-icon flaticon-layer"></i>',
            'title' => __d('acp', 'Patients'),
            'url' => ['plugin' => 'Acp', 'controller' => 'Patients', 'action' => 'index'],
            'submenu' => [
                [
                    'url' => ['plugin' => 'Acp', 'controller' => 'Patients', 'action' => 'index'],
        ...
        // __d('acp', 'Medical Requests') => [
        //     'icon' => '<i class="kt-menu__link-icon flaticon-doc"></i>',
        //     'title' => __d('acp', 'Medical Requests'),
        //     'url' => ['plugin' => 'Acp', 'controller' => 'MedicalRequests', 'action' => 'index'],
        //     'submenu' => [
        //         [
        //             'url' => ['plugin' => 'Acp', 'controller' => 'MedicalRequests', 'action' => 'index'],
        //             'title' => __d('acp', 'All Medical Requests')
        //         ]
        //     ]
        // ],
        __d('acp', 'Pharmacys') => [
            'icon' => '<i class="kt-menu__link-icon flaticon-home"></i>',
            'title' => __d('acp', 'Pharmacys'),
            'url' => ['plugin' => 'Acp', 'controller' => 'pharmacys', 'action' => 'index'],
            'submenu' => [
                [
                    'url' => ['plugin' => 'Acp', 'controller' => 'pharmacys', 'action' => 'index'],
                    'title' => __d('acp', 'All Pharmacys')
                ],
                [
                    'url' => ['plugin' => 'Acp', 'controller' => 'pharmacys', 'action' => 'add'],
                    'title' => __d('acp', 'Add Pharmacy')
                ]
            ]
        ],
        __d('acp', 'Users') => [
            ...
            'submenu' => [
             ...
             //    ],
                [
                    'url' => ['plugin' => 'Acp', 'controller' => 'Users', 'action' => 'account'],
                    'title' => __d('acp', 'All Account')
                ],
                [
                    'url' => ['plugin' => 'Acp', 'controller' => 'Users', 'action' => 'doctor'],
                    'title' => __d('acp', 'All Doctor')
                ],
                // [
