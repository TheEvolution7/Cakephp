...
Router::scope('/', function (RouteBuilder $routes) {
     ...
     */
    $routes->prefix('Patient', function (RouteBuilder $routes) {
    ...
    $routes->prefix('Practitioner', function (RouteBuilder $routes) {
        $routes->connect('/', ['controller' => 'Dashboards']);
        $routes->connect('/login', ['controller' => 'Users', 'action' => 'login']);

        $routes->connect(
            '/practitioner/resetPassword/:code.:id',
            [
                'controller' => 'users',
                'action' => 'resetPassword'
            ],
            [
                '_name' => 'practitioner-resetpassword',
                'pass' => [
                    'id',
                    'code'
                ],
