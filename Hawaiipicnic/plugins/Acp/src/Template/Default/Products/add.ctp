                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane active" id="tab_1" role="tabpanel">
                        <div class="row">
                            <div class="col-lg-9">
                                ...
                                <?= $this->Form->control('price', ['class' => 'form-control', 'label' => ['text' => 'Price ('.$this->getConfigure('Core')['setting']['currency'].')','class' => 'col-form-label col-md-3 col-sm-3 col-12']]); ?>
                    ...
                    <div class="tab-pane" id="tab_2" role="tabpanel">
                        ...
                        <div class="form-group">
                            <input type="file" name="image_list[]" class="file-upload-default d-none" multiple="multiple" id="fileImage" data-url="<?php echo $this->Url->build(['action' => 'uploadFile']) ?>">
