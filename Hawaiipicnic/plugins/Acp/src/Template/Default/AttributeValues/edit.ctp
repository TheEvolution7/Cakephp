...
<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
    ...
    <div class="kt-portlet kt-portlet--tabs">
        ...
        <div class="kt-portlet__body">
             <?= $this->Form->create($attribute_value, [
                'type' => 'file',
                'templates' => [
                        ...
                        <div class="row">
                            <div class="col-lg-9">
                                ...
                                <?php
                                    ...
                                    if (!empty($attribute_value->image)) {
                                        ...
                                        $imagePath = 'uploads' . DS . 'attribute_values' . DS . $attribute_value->id . DS . $attribute_value->image;
                                ...
                                <?= $this->Form->control('color', ['class' => 'form-control', 'label' => ['text' => __d('acp','Value'),'class' => 'col-form-label col-md-3 col-sm-3 col-12']]); ?>
                            ...
                            <!-- <div class="col-lg-3">
                                <div class="kt-avatar kt-avatar--outline kt-avatar--circle--" id="kt_apps_user_add_avatar">
                                    <div class="kt-avatar__holder h-auto">
