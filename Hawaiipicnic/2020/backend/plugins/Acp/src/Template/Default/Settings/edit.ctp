            ...
            ?>
                <div class="tab-content">
                    ...
                    <div class="tab-pane" id="tab_4" role="tabpanel">
                        <div class="row">
                            <div class="col-lg-9">
                                <?= $this->Form->control('author', ['class' => 'form-control', 'label' => ['class' => 'col-sm-3 col-form-label']]); ?>
                                <?= $this->Form->control('copyright', ['class' => 'form-control', 'label' => ['class' => 'col-sm-3 col-form-label']]); ?>
