...
Router::scope('/', function (RouteBuilder $routes) {
    ...
    $routes->connect('/about', ['controller' => 'Pages', 'action' => 'about'], ['routeClass' => 'ADmad/I18n.I18nRoute']);
    ...
    $routes->connect('/faq', ['controller' => 'Pages', 'action' => 'faq'], ['routeClass' => 'ADmad/I18n.I18nRoute']);
    $routes->connect('/faq', ['controller' => 'Pages', 'action' => 'faq']);

    $routes->connect('/party-favors', ['controller' => 'Pages', 'action' => 'partyfavors'], ['routeClass' => 'ADmad/I18n.I18nRoute']);
    $routes->connect('/party-favors', ['controller' => 'Pages', 'action' => 'partyfavors']);

    $routes->connect('/activities', ['controller' => 'Pages', 'action' => 'activities'], ['routeClass' => 'ADmad/I18n.I18nRoute']);
    $routes->connect('/activities', ['controller' => 'Pages', 'action' => 'activities']);

    $routes->connect('/snippets', ['controller' => 'Albums', 'action' => 'snippet'], ['routeClass' => 'ADmad/I18n.I18nRoute']);
    $routes->connect('/snippets', ['controller' => 'Albums', 'action' => 'snippet']);

    $routes->connect('/add-ons', ['controller' => 'Albums', 'action' => 'addOn'], ['routeClass' => 'ADmad/I18n.I18nRoute']);
    $routes->connect('/add-ons', ['controller' => 'Albums', 'action' => 'addOn']);
    ...
    $routes->connect(
        '/blog/',
        ['controller' => 'Articles', 'action' => 'news'], ['routeClass' => 'ADmad/I18n.I18nRoute']
    );
    $routes->connect(
        '/blog/',
    ...
    $routes->connect(
        '/services/',
        ['controller' => 'Articles', 'action' => 'service'], ['routeClass' => 'ADmad/I18n.I18nRoute']
    );
    $routes->connect(
        '/services/',
        ['controller' => 'Articles', 'action' => 'service']
    );
    $routes->connect(
        '/service/:slug-:id',
        ['controller' => 'Articles', 'action' => 'serviceDetails'], ['routeClass' => 'ADmad/I18n.I18nRoute']
    )
    ->setPass(['slug','id'])
    ->setPatterns([
        'slug' => '[a-z0-9-_]+',
    ...
    $routes->connect(
        '/service/:slug-:id',
        ['controller' => 'Articles', 'action' => 'serviceDetails']
    )
    ->setPass(['slug','id'])
    ->setPatterns([
        'slug' => '[a-z0-9-_]+',
    ...
    $routes->connect(
        '/blog/:slug-:id',
        ['controller' => 'Articles', 'action' => 'newsDetails'], ['routeClass' => 'ADmad/I18n.I18nRoute']
    )
    ->setPass(['slug','id'])
    ->setPatterns([
        'slug' => '[a-z0-9-_]+',
    ...
    $routes->connect(
        '/blog/:slug-:id',
        ['controller' => 'Articles', 'action' => 'newsDetails']
    )
    ->setPass(['slug','id'])
    ->setPatterns([
        'slug' => '[a-z0-9-_]+',
    ...
    $routes->connect(
        '/booking/',
        ['controller' => 'Products', 'action' => 'booking'], ['routeClass' => 'ADmad/I18n.I18nRoute']
    );
    $routes->connect(
        '/booking/',
        ['controller' => 'Products', 'action' => 'booking']
    );
    ...
    $routes->connect(
        '/booking/:slug-:id',
        ['controller' => 'Products', 'action' => 'bookingDetails'], ['routeClass' => 'ADmad/I18n.I18nRoute']
    )
    ->setPass(['slug','id'])
    ->setPatterns([
        'slug' => '[a-z0-9-_]+',
    ...
    $routes->connect(
        '/booking/:slug-:id',
        ['controller' => 'Products', 'action' => 'bookingDetails']
    )
    ->setPass(['slug','id'])
    ->setPatterns([
        'slug' => '[a-z0-9-_]+',
    ...
    $routes->connect(
        '/users/activeEmail/:code.:id',
        [
            'controller' => 'users',
            'action' => 'activeEmail'
        ],
        [
            '_name' => 'users-active-email',
            'pass' => [
                'id',
                'code'
            ],
