            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12"> <span class="heading-meta"><?= $banners[23][0]->title ?></span>
                        <h2 class="pwe-heading animate-box" data-animate-effect="fadeInLeft"><?= $banners[23][0]->description ?></h2>
                    </div>
                </div>
            </div>
        </div>
...
<div class="party-section">
    <div class="container-fluid">
        ...
        <?php foreach($banners[24] as $banner): ?>
        ...
        <div class="row">
            <div class="col-12">
                <div class="btn-book thumb-ani"><a href="<?= $this->Url->build(['controller' => 'Carts','action' => 'booking']) ?>" target="_blank"><span><?= __('Book Now') ?></span></a></div>
            </div>
        </div>
    </div>
</div>