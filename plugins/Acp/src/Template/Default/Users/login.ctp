                        ...
                        <?= $this->Form->create('Users', [
                            ...
                            ?>
                                <?= $this->Form->input('email', [
                                        ...
                                        'label' => false, 'class' => 'form-control', 'placeholder' => __d('acp', 'Username'), 'required' => 'required'
                                    ]);
                                ?>
                                <?= $this->Form->input('password', [
                                        ...
                                        'label' => false, 'class' => 'form-control', 'placeholder' => __d('acp', 'Password'), 'required' => 'required'
                                    ]);
                                ?>
