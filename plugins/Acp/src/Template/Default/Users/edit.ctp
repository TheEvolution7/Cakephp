                    ...
                    <div class="tab-pane active" id="tab_1" role="tabpanel">
                        <div class="row">
                            <div class="col-lg-9">
                                ...
                                ?>
                                <?php
                                    echo $this->Form->control('email', ['class' => 'form-control', 'label' => ['class' => 'col-form-label col-md-3 col-sm-3 col-12']]);
                                    echo $this->Form->control('password', ['type' => 'password','class' => 'form-control', 'label' => ['class' => 'col-form-label col-md-3 col-sm-3 col-12']]);
                                    echo $this->Form->control('confirm_password', ['type' => 'password', 'class' => 'form-control', 'label' => ['class' => 'col-form-label col-md-3 col-sm-3 col-12'],'value' => $user->password]);
                                    echo $this->Form->control('role_id', ['options' => $roles, 'class' => 'form-control kt-select2 select2', 'label' => ['class' => 'col-form-label col-md-3 col-sm-3 col-12']]);
                                    echo $this->Form->control('gender', ['options' => $genders, 'class' => 'form-control kt-select2 select2', 'label' => ['class' => 'col-form-label col-md-3 col-sm-3 col-12']]);
                                    echo $this->Form->control('first_name', ['class' => 'form-control', 'label' => ['class' => 'col-form-label col-md-3 col-sm-3 col-12']]);
                                    echo $this->Form->control('last_name', ['class' => 'form-control', 'label' => ['class' => 'col-form-label col-md-3 col-sm-3 col-12']]);
                                    // echo $this->Form->control('birthday', ['type' => 'text', 'class' => 'form-control', 'label' => ['class' => 'col-form-label col-md-3 col-sm-3 col-12']]);
                                    echo $this->Form->control('phone_number', ['class' => 'form-control', 'label' => ['class' => 'col-form-label col-md-3 col-sm-3 col-12']]);
                                    
                                    echo $this->Form->control('company', ['class' => 'form-control', 'label' => ['class' => 'col-form-label col-md-3 col-sm-3 col-12']]);
                                    echo $this->Form->control('address', ['class' => 'form-control', 'label' => ['class' => 'col-form-label col-md-3 col-sm-3 col-12']]);
                                    // echo $this->Form->control('city');
                                    // echo $this->Form->control('state');
                                    echo $this->Form->control('country_id', ['options' => $countries, 'empty' => true, 'class' => 'form-control kt-select2 select2', 'label' => ['class' => 'col-form-label col-md-3 col-sm-3 col-12']]);
                                    echo $this->Form->control('note', ['type' => 'textarea', 'class' => 'form-control', 'label' => ['class' => 'col-form-label col-md-3 col-sm-3 col-12']]);
                                ?>
