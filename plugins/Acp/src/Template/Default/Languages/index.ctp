                            ...
                            <?php foreach ($languages as $language): ?>
                                <tr data-id="<?= $language->id?>" class="text-center">
                                    ...
                                    <td>
                                        ...
                                        ?>
                                        <a href="<?= $this->Url->build(['action' => 'edit', $language->id]) ?>"><img src="<?php echo $this->Url->build(DS . $imagePath) ?>" class="thumbnail _cover"></a>
                                    </td>
                                    <td><?= h($language->def) ?></td>
                                    <td><?= h($this->Text->truncate($language->title, 120, ['ellipsis' => ' ...', 'exact' => false ])) ?></td>
                                    <td> 
                                    ...
                                    <td><?= $this->Element('Acp.Core' . DS . 'action', ['id' => $language->id]) ?></td>
                                    <td>
                                        <label class="kt-checkbox kt-checkbox--single kt-checkbox--solid no-mg">
