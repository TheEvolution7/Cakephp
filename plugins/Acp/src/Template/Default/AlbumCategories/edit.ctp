...
<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
    ...
    <div class="kt-portlet kt-portlet--tabs">
        ...
        <div class="kt-portlet__body">
             <?= $this->Form->create($albumCategory, [
                'type' => 'file',
                'templates' => [
                        ...
                        <div class="row">
                            <div class="col-lg-9">
                                ...
                                <?php
                                    ...
                                    if (!empty($albumCategory->image)) {
                                        
                                        $imagePath = 'uploads' . DS . 'album_categories' . DS . $albumCategory->id . DS . $albumCategory->image;
                                ...
                                <?= $this->Form->control('slug', ['class' => 'form-control', 'label' => ['class' => 'col-form-label col-md-3 col-sm-3 col-12']]); ?>
                                <?= $this->Form->control('description', ['type' => 'textarea', 'class' => 'form-control', 'label' => ['class' => 'col-form-label col-md-3 col-sm-3 col-12']]); ?>
                                <?= $this->Form->control('keyword', ['id' => 'kt_tagify_2','class' => 'form-control', 'label' => ['class' => 'col-form-label col-md-3 col-sm-3 col-12']]); ?>
