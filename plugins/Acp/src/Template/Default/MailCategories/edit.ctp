                        ...
                        <div class="row">
                            <div class="col-lg-9">
                                ...
                                <?php
                                    ...
                                    if (!empty($mailCategory->image)) {
                                        
                                        $imagePath = 'uploads' . DS . 'mailCategorys' . DS . $mailCategory->id . DS . $mailCategory->image;
