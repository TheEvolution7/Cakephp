...
<html lang="en">
    ...
    <head>
        ...
        <link rel="stylesheet" href="<?= $webrootAcp ?>css/dataTables.bootstrap.css">
        ...
        <!-- <script src="<?= $webrootAcp ?>//maps.google.com/maps/api/js?key=AIzaSyBTGnKT7dt597vo9QgeQ7BFhvSRP4eiMSM" type="text/javascript"></script> -->
        <script src="<?= $webrootAcp ?>vendors/custom/gmaps/gmaps.js" type="text/javascript"></script>
        <!--end::Page Vendors -->
        <!--begin::Page Scripts(used by this page) -->
        <!-- <script src="<?= $webrootAcp ?>js/pages/dashboard.js" type="text/javascript"></script> -->
    ...
    <body class="kt-quick-panel--right kt-demo-panel--right kt-offcanvas-panel--right kt-header--fixed kt-header-mobile--fixed kt-subheader--enabled kt-subheader--fixed kt-subheader--solid kt-aside--enabled kt-aside--fixed kt-page--loading">
                ...
                <div class="kt-aside  kt-aside--fixed  kt-grid__item kt-grid kt-grid--desktop kt-grid--hor-desktop" id="kt_aside">
                    ...
                    <div class="kt-aside__brand kt-grid__item " id="kt_aside_brand">
                        <div class="kt-aside__brand-logo">
                            <a href="<?= $this->Url->build(['plugin' => 'Acp', 'controller' => 'Pages', 'action' => 'dashboard']) ?>">
                                <img alt="Logo" src="<?= $webrootAcp ?>media/logos/logo-light.png" />
                            </a>
                        </div>
        ...
        <!-- <script src="<?= $webroot ?>packages/ckeditor/ckeditor.js"></script> -->
        ...
        <?php endif; ?>
        <!--begin:: Global Mandatory Vendors -->
        <script src="<?= $webrootAcp ?>old/vendors/js/vendor.bundle.base.js"></script>
        <script src="<?= $webrootAcp ?>old/vendors/js/vendor.bundle.addons.js"></script>

        <script src="<?= $webrootAcp ?>old/js/jq.tablesort.js"></script>
        <script src="<?= $webrootAcp ?>old/js/tablesorter.js"></script>
        <!-- <script src="<?= $webrootAcp ?>vendors/general/jquery/dist/jquery.js" type="text/javascript"></script> -->
