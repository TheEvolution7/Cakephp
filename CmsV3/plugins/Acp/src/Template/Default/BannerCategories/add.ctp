...
<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
    ...
    <div class="kt-portlet kt-portlet--tabs">
        ...
        <div class="kt-portlet__body">
             <?= $this->Form->create($bannerCategory, [
                'type' => 'file',
                'templates' => [
                        ...
                        <div class="row">
                            <div class="col-lg-9">
                                ...
                                <?= $this->Form->control('parent_id', [
                                    'options'       => $parentBannerCategories,
                                ...
                                <?php
                                    ...
                                    if (!empty($bannerCategory->image)) {
                                        
                                        $imagePath = 'uploads' . DS . 'bannerCategorys' . DS . $bannerCategory->id . DS . $bannerCategory->image;
