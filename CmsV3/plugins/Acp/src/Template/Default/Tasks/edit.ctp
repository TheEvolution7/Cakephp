                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-8">
                                ...
                                <div class="form-group row">
                                    <label class="col-form-label col-lg-3 col-sm-12"><?= __d('acp','Date') ?></label>
                                    <div class="col-lg-9 col-md-9 col-sm-12">
                                        <?php 
                                            $date = new FrozenTime($task->date);
                                        ?>
                                        <input name="date" type="text" class="form-control" id="kt_datetimepicker_1" readonly placeholder="Select date & time" value="<?= $date->format('Y-m-d H:i:s');  ?>" />
                                    </div>
                                </div>
                            </div> 
                            <div class="col-lg-2"></div>  
