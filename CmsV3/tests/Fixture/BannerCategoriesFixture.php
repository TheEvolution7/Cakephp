<?php
namespace Banner\Test\Fixture;

use Cake\TestSuite\Fixture\TestFixture;

/**
 * BannerCategoriesFixture
 *
 */
class BannerCategoriesFixture extends TestFixture
{
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'lft' => 1,
                'rght' => 1,
                'created' => '2019-03-07 00:52:01',
                'modified' => '2019-03-07 00:52:01'
            ],
        ];
        parent::init();
    }
